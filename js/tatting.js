...
$(function() {
        ...
        $('#toolbar-colors').simpleColorPicker({
        ...
        function drawTeardrop(startx, starty, endx, endy) {
            ...
            if (isTeardropDrawingInitiated) {
                isTeardropDrawingInitiated = false;
            } else {
            ...
            for (var t = 0; t < curvePointsArray.length; t += 1) {
                ...
                fabric.loadSVGFromString(simpleNode, function(objects, options) {
                    ...
                    teardropShapeArray.push(shapeCurve);
                });
            }
            teardropCurvePreview = new fabric.Group(teardropShapeArray, {
                    x1: teardropLine.x1,
                    x2: teardropLine.x2,
                    y1: teardropLine.y1,
                    y2: teardropLine.y2
